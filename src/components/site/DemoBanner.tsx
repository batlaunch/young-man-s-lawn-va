    ...
    <div className="bg-accent text-accent-foreground">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-2 text-xs sm:text-sm lg:px-8">
        <p className="leading-snug">
          👋 Hi James! This is a preview of what your professional website could look like. Everything here — your services, pricing, story, and brand — was built just for you.
        </p>
