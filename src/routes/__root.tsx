...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Professional lawn care, pressure washing, and engine repair in Chester and Chesterfield County, VA. Free estimates available." },
    ...
    links: [
      ...
      { rel: "canonical", href: "https://youngmanslawnva.com" },
    ],
  }),
